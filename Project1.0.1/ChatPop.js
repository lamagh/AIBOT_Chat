...
$(document).ready(function () {
  ...
  function addlinks(){
    ...
    link2.href = "https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css";
    link2.rel = "text/css";
...
function loadStylesheetsFromDynamicallyCreatedLinks() {
    var cssUrls = [
        { link: "https://fonts.googleapis.com", rel : "preconnect" , type : "text/css"},
        { link: "https://fonts.gstatic.com", rel : "preconnect" , type : "text/css"},
        { link: "https://fonts.googleapis.com", rel : "preconnect" , type : "text/css"},
        { link: "https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css", rel : "stylesheet" , type : "text/css"},
        { link: "https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Space+Mono:wght@400;700&display=swap", rel : "stylesheet" , type : "text/css"},
        { link: "https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css", rel : "stylesheet" , type : "text/css"},
  ...
  $(function () {
    ...
    loadStylesheetsFromDynamicallyCreatedLinks().then(function() {
      console.log('All stylesheets loaded from dynamically created link elements.');
    });
        ...
        <div id="chatActions" class="w-100 d-none">
          <div class="row mx-0 my-2">
            <div id="deleteChat" class="col text-center chat-action-icon mx-2 py-1">
              <img src="${ImageURL}/assets/delete-icon.png" alt="delete" />
              <span>Delete</span>
            </div>
            <div id="downloadChat" class="col text-center chat-action-icon mx-2 py-1">
              <img src="${ImageURL}/assets/download-icon.png" alt="download" />
              <span>Download</span>
            </div>
          </div>
        </div>
...
`;
  ...
  $("#chatMain").on("click", ".hide-chat-box", function () {
    $.ajax({
      ...
      url: `https://aicbapis.ctsdemo.ae/auth/validate`,
      type: "GET",
      contentType: "application/json; charset=utf-8",
      retries: 2,
      success: (data) => {
